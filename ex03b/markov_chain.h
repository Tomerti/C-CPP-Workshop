...
#define ALL_ERROR "Allocation failure: Failed to allocate new memory\n"
...
typedef int (*comp)(void *data1, void *data2);
typedef void (*fr_data)(void *data);
typedef void* (*copy_f)(void *data);
typedef bool (*is_lst)(void *data);
